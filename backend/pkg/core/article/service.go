...
// CreateDraftShell creates an empty draft article that will be populated by a chat session.
func (s *Service) CreateDraftShell(ctx context.Context, title string, authorID uuid.UUID) (*models.Article, error) {
