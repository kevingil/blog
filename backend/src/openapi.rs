...
pub fn router() -> OpenApiRouter<AppState> {
    OpenApiRouter::new()
        ...
        .merge(api::article::router())
        .merge(api::datasource::router())
        .merge(api::image::router())
        .merge(api::insight::router())
        .merge(api::organization::router())
        .merge(api::page::router())
        .merge(api::profile::router())
        .merge(api::project::router())
        .merge(api::source::router())
        .merge(api::storage::router())
        .merge(api::taskrun::router())
        .merge(api::worker::router())
