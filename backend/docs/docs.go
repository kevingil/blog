    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ArticleVersionResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ArticleVersionListResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.PageListResponse"
                                        }
                                    }
                                }
                            ]
        ...
        "/dashboard/pages/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Page update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/profile/settings": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Site settings update",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/sources/article/{articleId}/search": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/sources/{sourceId}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Source update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/storage/folders": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Old and new folder paths",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/storage.UpdateFolderRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/storage.CreateFolderRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.ArticleResponse": {
            ...
            "properties": {
                ...
                "published_title": {
                    "description": "Published content (for public viewing)",
                    "type": "string"
                },
                "slug": {
        ...
        "dto.ArticleVersionListResponse": {
            "type": "object",
            "properties": {
                "total": {
                    "type": "integer"
