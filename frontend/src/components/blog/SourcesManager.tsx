                ...
                sources.map((source) => (
                  <Card
                    ...
                    className={`border cursor-pointer transition-colors ${
                      selectedSource?.id === source.id ? 'border-primary bg-primary/10' : 'hover:bg-accent'
                    }`}
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col space-y-4 min-h-0">
                  ...
                  {(!useUrlScraping && !isEditing) || (isEditing && formData.source_type !== 'web') ? (
                    ...
                    <div className="space-y-2 flex-1 flex flex-col min-h-0">
                      ...
                      <div className="flex-1 min-h-[300px] p-3 border rounded-md bg-muted/40 overflow-y-auto">
