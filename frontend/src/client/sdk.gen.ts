...
export class Agent {
    ...
    public static listMcpConnectors<ThrowOnError extends boolean = false>(options?: Options<ListMcpConnectorsData, ThrowOnError>) {
        return (options?.client ?? client).get<ListMcpConnectorsResponses, ListMcpConnectorsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static createMcpConnector<ThrowOnError extends boolean = false>(options: Options<CreateMcpConnectorData, ThrowOnError>) {
        return (options.client ?? client).post<CreateMcpConnectorResponses, CreateMcpConnectorErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/agent/connectors',
            ...options,
            headers: {
    ...
    public static deleteMcpConnector<ThrowOnError extends boolean = false>(options: Options<DeleteMcpConnectorData, ThrowOnError>) {
        return (options.client ?? client).delete<DeleteMcpConnectorResponses, DeleteMcpConnectorErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static updateMcpConnector<ThrowOnError extends boolean = false>(options: Options<UpdateMcpConnectorData, ThrowOnError>) {
        return (options.client ?? client).patch<UpdateMcpConnectorResponses, UpdateMcpConnectorErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/agent/connectors/{connectorId}',
            ...options,
            headers: {
    ...
    public static refreshMcpConnector<ThrowOnError extends boolean = false>(options: Options<RefreshMcpConnectorData, ThrowOnError>) {
        return (options.client ?? client).post<RefreshMcpConnectorResponses, RefreshMcpConnectorErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static submitConversationTurn<ThrowOnError extends boolean = false>(options: Options<SubmitConversationTurnData, ThrowOnError>) {
        return (options.client ?? client).post<SubmitConversationTurnResponses, SubmitConversationTurnErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static connectLiveSession<ThrowOnError extends boolean = false>(options?: Options<ConnectLiveSessionData, ThrowOnError>) {
        return (options?.client ?? client).get<unknown, ConnectLiveSessionErrors, ThrowOnError>({ url: '/agent/live', ...options });
    }

    public static listAgentSkills<ThrowOnError extends boolean = false>(options?: Options<ListAgentSkillsData, ThrowOnError>) {
        return (options?.client ?? client).get<ListAgentSkillsResponses, ListAgentSkillsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/agent/skills',
            ...options
        });
    ...
    public static createAgentSkill<ThrowOnError extends boolean = false>(options: Options<CreateAgentSkillData, ThrowOnError>) {
        return (options.client ?? client).post<CreateAgentSkillResponses, CreateAgentSkillErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/agent/skills',
            ...options,
            headers: {
    ...
    public static deleteAgentSkill<ThrowOnError extends boolean = false>(options: Options<DeleteAgentSkillData, ThrowOnError>) {
        return (options.client ?? client).delete<DeleteAgentSkillResponses, DeleteAgentSkillErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static updateAgentSkill<ThrowOnError extends boolean = false>(options: Options<UpdateAgentSkillData, ThrowOnError>) {
        return (options.client ?? client).patch<UpdateAgentSkillResponses, UpdateAgentSkillErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/agent/skills/{skillId}',
            ...options,
            headers: {
    ...
    public static listAgentTools<ThrowOnError extends boolean = false>(options?: Options<ListAgentToolsData, ThrowOnError>) {
        return (options?.client ?? client).get<ListAgentToolsResponses, ListAgentToolsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
            url: '/agent/tools',
            ...options
        });
