        ...
        <Card className="gap-4 py-4">
          ...
          <CardContent className="px-5 space-y-3 text-sm">
            ...
            {run.metrics && Object.keys(run.metrics).length > 0 && (
              <pre className="rounded-lg border border-border bg-muted/50 p-3 text-xs text-foreground whitespace-pre-wrap">
              ...
              events.map((event) => (
                <div key={event.id} className="rounded-lg border border-border bg-card p-3">
                  ...
                  {event.meta_data && Object.keys(event.meta_data).length > 0 ? (
                    <pre className="mt-3 rounded-md border border-border bg-muted/50 p-2 text-[11px] text-foreground whitespace-pre-wrap">
