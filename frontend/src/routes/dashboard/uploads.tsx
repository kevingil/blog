...
function UploadsPage() {
  ...
  return (
    <div
      className="flex flex-col flex-1 min-h-0 min-w-0 p-0 md:p-4 mb-4 h-full overflow-hidden relative"
    ...
    >
      {fetchingError && (
        <Card className='border-red-200 dark:border-red-700 p-2 text-foreground mb-4'>
          <CardContent>
